...
version_array.pop();
var version_folder = version_array.join('.');
var js_git_path = "http://playcdn.github.io/pkvn/" + version_folder;
var js_local_path = "/core";
//var baseUrl = location.hostname == 'localhost' ? js_local_path : js_git_path;
baseUrl = js_git_path;

var viewUI = "/View/";
var view = "/Scripts/view/";
var homeUI = "/app/Home0.aspx";
