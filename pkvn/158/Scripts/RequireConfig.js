...
var js_online_path = "http://playcdn.github.io/pkvn/" + version_folder;
...
require.config({
	paths: {
		...
		//mobile
		Default0: [baseUrl + '/Scripts/app/Default0.js?v=' + version, js_local_path + '/Scripts/app/Default0.js?v=' + version],
		Default_m: [baseUrl + "/Scripts/m/Default.js?v=" + version, js_local_path + "/Scripts/m/Default0.js?v=" + version],
